...
class TestEmployeeFormChrome(unittest.TestCase):
    ...
    def test01_add_employee(self):  # ===== TC-01: Verify the "Add Employee" icon and form functionality.
    ...
    def test02_edit_icon(self):  # ========== TC-02: Verify the "Employee Info" icon functionality.
        ...
        while True:
            ...
            try:
                ...
                edit_icon = WebDriverWait(self.driver, 10).until(
                    EC.presence_of_element_located((By.XPATH, record_xpath)))
                ...
                try:
                    title = self.driver.find_element(By.XPATH, "//h3[contains(.,'Employee Info')]")

                    fNameBox = self.driver.find_element(By.XPATH, "//input[@name='firstName']")
                    # Read the First name
                    firstName = fNameBox.get_attribute("value")

                    lNameBox = self.driver.find_element(By.XPATH, "//input[@name='lastName']")
                    # Read the Last name
                ...
                # ............. Click on "Cancel" .......................
                cancelBtn = self.driver.find_element(By.XPATH, "//button[contains(.,'Cancel')]")
                cancelBtn.click()
                ...
                page_number += 1
                try:
                    next_page_button = self.driver.find_element(By.XPATH, f"//button[contains(.,'{page_number}')]")
